...
@section('menu-izquierda')
                ...
                <a class="active" href="<?=URL::to('coord/index')?>">
                        ...
                        <span>MENU COORDINADOR</span>
                </a>
                </li>
                <li class="sub-menu">
                    <a href="Gestionar Programas">
                        <i class="fa fa-book"></i>
                        <span>GESTIONAR PROGRAMA</span>
                    </a>
                    <ul class="sub">
                        <li><a href="<?=URL::to('coord/Programnew')?>">REGISTRAR PROGRAMA</a></li>
                        <li><a href="<?=URL::to('coord/Programshow')?>">LISTAR PROGRAMAS</a></li>
                        <li><a href="<?=URL::to('coord/Programshow')?>">REGISTRAR MODULOS</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>ADMINISTRAR KARDEX</span>
                    </a>
                    <ul class="sub">
                        <li><a href="">LISTAR ESTUDIANTES</a></li>
                        <li><a href="">SEGUIMIENTO ACADEMICO</a></li>
