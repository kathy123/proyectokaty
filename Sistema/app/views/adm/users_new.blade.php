...
@section('content')
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel panel-primay">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" method="post" action="<?=URL::to('admi/userssave');?>">
                                    ...
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-3">CONTRASEÑA</label>
                                        <div class="col-lg-6">
                                     ...
                                     <div class="form-group">
                                        <label for="cname" class="control-label col-lg-3">ROL</label>
                                        <div class="col-lg-6">
                                            @if($rol)
