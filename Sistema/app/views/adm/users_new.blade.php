        ...
        <div class="row">
            <div class="col-sm-12">
                <section class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" method="post" action="<?=URL::to('admi/userssave');?>">
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Nombre de Usuario</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="username" minlength="5" type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-3">Contrase:a</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="ccomment" name="password" minlength="8" required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input value="{{$persona->id_dpersona}}" type="hiden" name="persona">
                                    </div>
                                    <div class="form-group">
                                        <label for="roles" class="control-label col-lg-3">ROL</label>
                                        <div class="col-lg-6">
                                            @if($rol)
                                               <select placeholder="seleccione una opcion" name="roles" id="focusedInput" class="form-control input-sm m-bot15" required> 
                                               @foreach($rol as $roles)
                                               <option value="{{$roles->idroles}}">{{$roles->nombre}}</option>
                                               @endforeach
                                               </select>
                                            @else
                                               <div class="col-lg-6">        
