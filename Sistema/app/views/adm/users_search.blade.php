        ...
        <!-- sidebar menu start-->            <div class="leftside-navigation">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li><a href="<?=URL::to('admi/usersnew')?>">este nooo</a></li>
                    <li><a href="<?=URL::to('admi/usersshow')?>">Ver Todos</a></li>
                    <li><a href="<?=URL::to('admi/userssearch')?>">Nuevo</a></li>
            ...
            <div class="col-sm-12">
                <section class="panel panel-primary">
                    <header class="panel-heading">
                        Buscar a la persona para crear cuenta
                    </header>
                    <div class="panel-body">
                        <form class="cmxform form-horizontal " id="commentForm" method="post" action="<?=URL::to('admi/usernew');?>">
                                    <div class="form-group ">
                                        <div class="col-lg-3">
                                            <label for="id" class="control-label col-lg-3">Cedula de Identidad</label>
                                        </div>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="id" name="id" minlength="5" type="text" required />
                                        </div>
                                        <div class="col-lg-3">
                                            <button class="btn btn-round btn-success" title="Realizar busqueda" type="submit"><i class="fa fa-search"></i>Buscar</button>
                                        </div>
                                    </div>
                        </form>
                    </div>
