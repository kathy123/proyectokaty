                        ...
                        <section id="unseen">
                            ...
                            <table class="table table-bordered table-striped table-condensed">
                                ...
                                <tr>
                                     ...
                                     <td><a class="btn btn-warning btn-xs" href= "" title="editar usuario"><i class="fa fa-edit"></i></a>
                                     <a class="btn btn-danger btn-xs" href="" title="dar de baja"><i class="fa fa-trash"></i></a></td>
                                 <?php $i++; ?>
                                </tr>
                                @endforeach
                                </tbody>
