      ...
      <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a>EVENTOS</a></li>
                        <li class="active">Nueva Evento</li>
                    </ul>
                    <!--breadcrumbs end -->
                </div>
        </div>
                ...
                <div class="col-lg-12">
                    <section class="panel panel-primary">
                        ...
                        <div class="panel-body"> 
                            <div class="form">
                                <form class="cmxform form-horizontal" id="commentForm" method="post" action="<?=URL::to('admi/eventsave');?>">
                                    <fieldset>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea rows="15" name="descripcion" id="descripcion"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
