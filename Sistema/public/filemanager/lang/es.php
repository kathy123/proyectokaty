...
define('lang_File_Permission', 'Permisos de Archivo');
...
define('lang_File_Open_Edit_Not_Allowed', 'Tu no tienes permitido a %s este archivo.'); // %s = open or edit
define('lang_Edit', 'Editar');
define('lang_Edit_File', "Editar contenido de Archivo");
define('lang_File_Save_OK', "Archivo Guardado Correctamente.");
define('lang_File_Save_Error', "Ah ocurrido un error al guardar Archivo.");
define('lang_New_File','Nuevo Archivo');
define('lang_No_Extension','Tu tienes que agregar la extension al archivo.'); 
define('lang_Valid_Extensions','Extensiones Validas: %s'); // %s = txt,log etc.
